...
import { getProposals } from "@/api/proposal-penawaran";
import type { ProposalPenawaran } from "./types";

export default function ProposalPenawaranPage() {
  const [proposals, setProposals] = useState<ProposalPenawaran[]>([]);
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div className="flex flex-col gap-1">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">
            Dokumen tertulis yang lengkap dan persuasif untuk meyakinkan calon klien agar memilih
